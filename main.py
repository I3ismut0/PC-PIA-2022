...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog=
        "HASH: WEBSCRAPING: Para esta opcion se necesita la url de una pagina web,\
        VERIFICACION DE CORREO: se necesita un correo que este dentro del archivo generado por el webscraping\
        VER PUERTOS ABIERTOS: se necesita una direccione ip la cual puedes buscar con el comando para ver ip's disponibles")
